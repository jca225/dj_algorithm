...
import os
data_directory = "/Users/johnmabrahams/Operation Pierce Fulton/data/"
# TODO: Add code to see if the file was already added.
# TODO: Orchestrate Captcha with retry method
# Asynchronous: 1. screenshot, 2. send email to me, 3. allow me to input!  
...
for artist_folder in os.listdir(data_directory):
    ...
    for artist_url in artist_set_urls:
        try:
            ...
            time.sleep(10 * 60) # Wait 10 minutes - 5 minutes does not work
